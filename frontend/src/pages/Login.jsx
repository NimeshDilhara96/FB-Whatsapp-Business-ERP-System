...
export default function Login() {
    ...
    return (
        <>
            {/* ── Server Cold-Start Loading Overlay ── */}
            {isLoading && (
                <div className="ss-overlay">
                    {/* Spinner */}
                    <svg className="ss-spinner" width="36" height="36" viewBox="0 0 36 36" fill="none">
                        <circle cx="18" cy="18" r="15" stroke="#27272a" strokeWidth="2.5" />
                        <path d="M18 3 A15 15 0 0 1 33 18" stroke="#6366f1" strokeWidth="2.5" strokeLinecap="round" />
                    </svg>

                    {/* Text */}
                    <div className="ss-text-group">
                        <p className="ss-title">Starting server…</p>
                        <p className="ss-subtitle">Free tier cold start — usually 10–30 s</p>
                    </div>
            ...
            <div className="min-h-screen bg-gradient-to-br from-base-bg to-primary-50 flex flex-col items-center justify-center p-4 md:relative">
                ...
                <div className="w-full max-w-md">
                    ...
                    <Card className="p-8">
                        ...
                        {/* Login Button */}
                        <Button onClick={handleLogin} fullWidth className="mt-6" disabled={isLoading}>
