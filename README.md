...
![Order Flow ERP](https://img.shields.io/badge/Status-Active-success) ![Version](https://img.shields.io/badge/Version-v1.2.0-blue)
...
- _Note:_ When deploying, ensure you configure Cross-Domain CORS properly by setting your `VITE_API_URL` on Vercel and your `FRONTEND_URL` on Render.
...
_Built with modern web standards by MommentX._
